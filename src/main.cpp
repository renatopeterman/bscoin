...
uint256 hashGenesisBlock("0xde821d8e191799564820ca698d02b62785a21b035db977d6f3cbaef45a79e7e9");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // BsCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BsCoin Signed Message:\n";
...
{
    // BsCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // BsCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // BsCoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // BsCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BsCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // BsCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // BsCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x40b28a635591e9a58fb1a17683e0a9cadebf33c44e44a0838008f7e173623012");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "The answer to life, the universe and everything";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1397396562;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2332433;

        if (fTestNet)
        {
            block.nTime    = 1396792070;
            block.nNonce   = 921311;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xae11f66894d7e25665d67a8543965678a78db72953d185fbab4461e0f3b36225"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // BsCoin: increase each by adding 2 to bitcoin's value.
